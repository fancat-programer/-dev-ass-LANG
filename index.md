...
- команда "include <название файла(строка)>" - загрузка функций из другого файла.
...
6. При попытке объявить переменную или функцию с числовым названием будет вызвана ошибка. (смотрите в разделе "ОШИБКИ"[14])
7. При попытке объявить переменную или функцию с использованным именем будет вызвана ошибка.(смотрите в разделе "ОШИБКИ"[7])

Примеры:
```
int 1 = 0; /* будет вызвана 14 ошибка. */
```
...
14. You try to initialize a function/variable with a numeric name.
